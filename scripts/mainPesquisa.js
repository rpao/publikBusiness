...
FriendlyChat.prototype.loadPesquisas = function() {
  ...
  var setMessage = function(data) {
    var val = data.val();
    this.displayPesquisas(data.key, val.pergunta, val.respostas, val.escolhas);
  }.bind(this);
...
FriendlyChat.prototype.displayPesquisas = function(key, pergunta, respostas, escolhas) {   
  ...
  if (!div) {
    ...
    container.innerHTML = '<div class="col-md-12">'+
      ...
      '<div class="pergunta card-header text-center"></div>' +
	  '<div class="escolhas text-muted"></div>' +
	  '<i><div class="respostas text-muted"></div></i>' +
	  '</div>'+
	  '</div>'+
      '</div>';
  ...
  var respostasElement = div.querySelector('.respostas');
  var escolhasElement = div.querySelector('.escolhas');
  ...
  respostasElement.textContent = "Respostas: "+respostas;
  escolhasElement.textContent = "Opções: "+escolhas;
